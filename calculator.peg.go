...
func (p *Calculator) Init(options ...func(*Calculator) error) error {
	...
	_rules = [...]func() bool{
		...
		/* 5 value <- <(imaginary / number / exp1 / exp2 / pi / prec / log / sqrt / cos / sin / sub)> */
		func() bool {
		...
		func() bool {
			position87, tokenIndex87 := position, tokenIndex
			{
				...
				add(ruleexponentiation, position88)
			}
			return true
		l87:
